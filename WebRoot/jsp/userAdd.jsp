...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/user/userRest">
		<div class="content">
			<table class="box">
			   <tbody><tr>
				...
				<tr>
					...
					<td><input type="radio" name="userrole" value="1">管理员<input type="radio" name="userrole" value="2" checked="true">普通用户
					<input type="radio" name="userrole" value="3">经理</td>
				</tr>
			</tbody></table>
		</div>
		<div class="buttons">
